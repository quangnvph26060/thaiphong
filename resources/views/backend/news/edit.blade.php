                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="article" class="form-control" id="article" placeholder="Nội dung">{!! old('article', $news->article) !!}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-0">
                            <img src="{{ showImage($news->featured_image) }}" alt="" id="image_main"
